...
public class DriveSubsystem extends SubsystemBase {
  ...
  private SwerveDrivePoseEstimator m_odometry = new SwerveDrivePoseEstimator(DriveConstants.kDriveKinematics,
  ...
  public DriveSubsystem() {
    ...
    SmartDashboard.putData(
        ...
        builder -> {
          ...
          builder.addDoubleProperty(
              "Robot Angle", () -> -m_gyro.getAngle(), null);
        });
  ...
  public Pose2d calculateTagOffset(
    ...
    double robotHalfLength = Units.inchesToMeters(15.25 + distantOffset);
